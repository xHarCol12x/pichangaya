...
export class ClientsService {
    ...
    async create(tenantId: string, data: { name: string; phone: string; email?: string; notes?: string; venueId: string }) {
    ...
    async update(id: string, tenantId: string, data: { name?: string; phone?: string; email?: string; notes?: string; venueId?: string }) {
