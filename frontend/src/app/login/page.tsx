            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12">
                <div className="w-full max-w-md">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 dark:text-slate-400">Qué bueno verte de nuevo por aquí.</p>
                    </div>
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase font-medium">
                            <span className="bg-background px-4 text-slate-400">O continuar con</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm">
                            ...
                            <TransitionLink href="/register" className="text-accent font-bold hover:underline">
                                Regístrate gratis
                            </TransitionLink>
                        </p>
                    </div>
