...
const KpiCard = ({ title, value, sub, change, positive, icon: Icon, accent }: any) => {
    ...
    return (
        <div ref={ref} className="h-full glass p-3.5 md:p-6 rounded-[1.5rem] md:rounded-[2rem] border border-border relative group overflow-hidden flex flex-col justify-center gap-2 transition-all hover:bg-white/[0.02]">
